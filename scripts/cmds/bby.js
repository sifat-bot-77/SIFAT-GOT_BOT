...
module.exports.onChat = async ({ api, event, usersData }) => {
    try {
        ...
        if (body.startsWith("Bot") || body.startsWith("BOT") || body.startsWith("bot") || body.startsWith("bbz") || body.startsWith("baby") || body.startsWith("bby")) {
            ...
            const senderName = (await usersData.getName(uid)) || "User";
            const baseReplies = [
                "জান তোমার বান্ধবী রে আমার বস মুকুল হাতে তুলে দিবা?😗", "পরকিয়া করছোছ নাকি শালা-🥲🤧", "কি খবর কেমনের আছো? 😊", "আজকে তো অনেক দিন পর কথা বলছো 😒",
                "কোথায় ছিলি এতদিন? 🤔", "ভালোবাসা নামক আবলামী করতে চাইলে Boss মুকুল এর ইনবক্সে গুতা দিন!🫡", "বলো না ভালোবাসি! 🥹", "ওই জান কাছে আসো! 🫦😩", "আলাবু বলো সোনা 🤧", "মুকুল রে দেখছো? 🥺 তাকে কোথাও খুজে পাচ্ছি না 😩", "চুম্মা দাও ৫ টাকা দিবো!🥺🤌", "হ্যাঁ গো জান বলো 🙂", "তুমি কি আমাকে পসন্দ করো 🙂", "মেয়ে হলে আমার বস মুকুল এর ইনবক্সে এখুনি গুঁতা দিন!😉",
                "তোর জন্য রোজ দোয়া করি ❤️", "চুনা ও চুনা আমার বস মুকুল এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না!🥺", "- আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস মুকুল কে দান করেন!😏", "- ও মিম ও মিম!😇 - তুমি কেন চুরি করলা সাদিয়ার ফর্সা হওয়ার ক্রীম!🐸",
                "- আমার গল্পে তোমার নানি সেরা!🙂🫀", "- আজ একটা বিন নেই বলে ফেসবুকের নাগিন গুলোরে আমার বস মুকুল ধরতে পারছে না!🐸", "~ যে ছেড়ে গেছে তাকে ভুলে যাও, আমার বস মুকুল এর সাথে প্রেম করে তাকে দেখিয়ে দাও!🥲🫶", "~ হাজারো লুচ্চা লুচ্চির ভিরে আমার বস মুকুল এক নিস্পাপ ভালো মানুষ!🫦",
                "~ একদিন সে ঠিকই ফিরে তাকাবে আর মুচকি হেসে বলবে ওর মতো আর কেউ ভালবাসেনি!🙂💔", "কি'রে গ্রুপে দেখি একটাও বেডি নাই!?🙄", "~ দেশের সব কিছুই চুরি হচ্ছে শুধু আমার বস মুকুল এর মনটা ছাড়া!😑", "তোকে আল্লাহ আমার জন্য রেখেছে বলে বিশ্বাস হয় 🤲", "~ 🫵 তোমারে প্রচুর ভাল্লাগে সময় মতো প্রপোজ করমু বুঝছো? ছিট খালি রাইখো! 🫣", "~ সাবধানে থাকিস তোরে আমার ভাল লাগছে!😒", "~ আজ থেকে আর কাউকে পাত্তা দিমু না !😏 কারণ আমি ফর্সা হওয়ার ক্রিম কিনছি !🥱", "Tung Tung Tedaw ! 🐸", "Kirish Ka Gana Sunega??🗣️"
            ];
